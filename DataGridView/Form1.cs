...
namespace DataGridView
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (changed)
            {
                DialogResult result = MessageBox.Show("Сохранить изменения?", "Сохранить", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                switch (result)
                {
        ...
        private void New()
        {
            if (changed)
            {
                DialogResult result2 = MessageBox.Show("Сохранить изменения?", "Сохранить", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                switch (result2)
                {
                    case DialogResult.Yes:
                        {
